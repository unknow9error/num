...
process implementation. JavaScript/TypeScript consumers can use the generated
types without owning the `.num` parser or policy model.
...
The generated file is intentionally checked in so JS/TS consumers can inspect
the contract without running the generator first.
